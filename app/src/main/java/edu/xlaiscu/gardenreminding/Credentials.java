...
public class Credentials {
    ...
    static final String CLIENT_ID = "UZ_XKpMl6QImQJZGsxlIdsAOt6DvtDG0KDLTPazY";
    static final String CLIENT_SECRET = "n1PVB03Rns03y1jgffAh1I5HVmBFErbbY6aRy4ub";
